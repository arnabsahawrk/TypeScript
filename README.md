...
- inferred Typing
  ...
  ```js
  let userName = "Arnab"; // data type inferred as string
  ```
...
2. **object**: Represents any non-primitive value.
   ...
   user1 = { userName: "Arnab", userId: 101 };
   users.push(user1);

   let user2: { userName: string; userId: number };
   user2 = { userName: "Riya", userId: 102 };
...
3. **array**: Represents an array of values of a specific type. 2 ways to declare: `number[]` or `Array<number>`
   ...
   // let users = ["Arnab", "Riya", "pinky"];

   // let users: string[];
   // users = ["Arnab", "Riya", "pinky"];
...
7. **Custom Type**: you can create your own type
   ...
   let user3: User;
   user3 = { userName: "Sima", userId: 103 };
   users.push(user3);
...
8. **class Type OOP** - You can create class type as well. class can have constructor, properties, methods. create object let objectName = new className()
   ...
   let user1 = new User("Arnab Saha", 25);
   user1.display();

   let user2 = new User("Riya Saha", 24);
   user2.display();
   ```
   ...
   let student1 = new Student("Riya", 24, 1302020015);
   student1.display();
   ...
   ![Access Modifiers](image/access-modifiers.png)
...
10. **Interface vs type**
    ...
    const s1 = new Student("Arnab Saha", "1302020017");
...
- Function signature
  ...
  userInfo1 = () => {
    console.log("Arnab Saha is 25 years old");
  };
  ...
  userInfo3 = (name: string): string => {
    return `${name} is 25 years old`;
  };

  userInfo1();
  userInfo2("Arnab Saha");
  console.log(userInfo3("Arnab Saha"));
  ```
